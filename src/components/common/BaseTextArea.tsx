import React, {forwardRef, HTMLAttributes, TextareaHTMLAttributes, useState} from 'react'
...
const BaseTextArea = forwardRef<Omit<HTMLTextAreaElement, 'dangerouslySetInnerHTML'>, BaseTextAreaProps>(
  (
    {
      state = 'normal',
      inputSize = 'medium',
    ...
    const isFocus = (e: React.FocusEvent<HTMLTextAreaElement>) => {
      setIsFocused(true)
      onFocus?.(e)
    }

    const isBlur = (e: React.FocusEvent<HTMLTextAreaElement>) => {
      setIsFocused(false)
      onBlur?.(e)
    }
